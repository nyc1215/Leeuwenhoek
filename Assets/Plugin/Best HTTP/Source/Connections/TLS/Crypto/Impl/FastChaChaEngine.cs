...
namespace BestHTTP.Connections.TLS.Crypto.Impl
{
        ...
        : FastSalsa20Engine
    {
        ...
        class ChaChaBurstHelper
        {
            [Unity.Burst.BurstCompile]
            public unsafe static void ChachaCore(int rounds, uint* input, uint* x)
            {
                uint x00 = input[0];
                uint x01 = input[1];
                uint x02 = input[2];
                ...
                for (int i = rounds; i > 0; i -= 2)
                {
                    x00 += x04;
                    uint temp = x12 ^ x00;
                    x12 = (temp << 16) ^ (temp >> -16); //Integers.RotateLeft(x12 ^ x00, 16);
                    x08 += x12;
                    temp = x04 ^ x08;
                    x04 = (temp << 12) ^ (temp >> -12);// Integers.RotateLeft(x04 ^ x08, 12);
                    x00 += x04;
                    temp = x12 ^ x00;
                    x12 = (temp << 8) ^ (temp >> -8);// Integers.RotateLeft(x12 ^ x00, 8);
                    x08 += x12;
                    temp = x04 ^ x08;
                    x04 = (temp << 7) ^ (temp >> -7);// Integers.RotateLeft(x04 ^ x08, 7);
                    x01 += x05;
                    temp = x13 ^ x01;
                    x13 = (temp << 16) ^ (temp >> -16);// Integers.RotateLeft(x13 ^ x01, 16);
                    x09 += x13;
                    temp = x05 ^ x09;
                    x05 = (temp << 12) ^ (temp >> -12);// Integers.RotateLeft(x05 ^ x09, 12);
                    x01 += x05;
                    temp = x13 ^ x01;
                    x13 = (temp << 8) ^ (temp >> -8);// Integers.RotateLeft(x13 ^ x01, 8);
                    x09 += x13;
                    temp = x05 ^ x09;
                    x05 = (temp << 7) ^ (temp >> -7);// Integers.RotateLeft(x05 ^ x09, 7);
                    x02 += x06;
                    temp = x14 ^ x02;
                    x14 = (temp << 16) ^ (temp >> -16);// Integers.RotateLeft(x14 ^ x02, 16);
                    x10 += x14;
                    temp = x06 ^ x10;
                    x06 = (temp << 12) ^ (temp >> -12);// Integers.RotateLeft(x06 ^ x10, 12);
                    x02 += x06;
                    temp = x14 ^ x02;
                    x14 = (temp << 8) ^ (temp >> -8);// Integers.RotateLeft(x14 ^ x02, 8);
                    x10 += x14;
                    temp = x06 ^ x10;
                    x06 = (temp << 7) ^ (temp >> -7);// Integers.RotateLeft(x06 ^ x10, 7);
                    x03 += x07;
                    temp = x15 ^ x03;
                    x15 = (temp << 16) ^ (temp >> -16);// Integers.RotateLeft(x15 ^ x03, 16);
                    x11 += x15;
                    temp = x07 ^ x11;
                    x07 = (temp << 12) ^ (temp >> -12);// Integers.RotateLeft(x07 ^ x11, 12);
                    x03 += x07;
                    temp = x15 ^ x03;
                    x15 = (temp << 8) ^ (temp >> -8);// Integers.RotateLeft(x15 ^ x03, 8);
                    x11 += x15;
                    temp = x07 ^ x11;
                    x07 = (temp << 7) ^ (temp >> -7);// Integers.RotateLeft(x07 ^ x11, 7);
                    x00 += x05;
                    temp = x15 ^ x00;
                    x15 = (temp << 16) ^ (temp >> -16);// Integers.RotateLeft(x15 ^ x00, 16);
                    x10 += x15;
                    temp = x05 ^ x10;
                    x05 = (temp << 12) ^ (temp >> -12);// Integers.RotateLeft(x05 ^ x10, 12);
                    x00 += x05;
                    temp = x15 ^ x00;
                    x15 = (temp << 8) ^ (temp >> -8);// Integers.RotateLeft(x15 ^ x00, 8);
                    x10 += x15;
                    temp = x05 ^ x10;
                    x05 = (temp << 7) ^ (temp >> -7);// Integers.RotateLeft(x05 ^ x10, 7);
                    x01 += x06;
                    temp = x12 ^ x01;
                    x12 = (temp << 16) ^ (temp >> -16);// Integers.RotateLeft(x12 ^ x01, 16);
                    x11 += x12;
                    temp = x06 ^ x11;
                    x06 = (temp << 12) ^ (temp >> -12);// Integers.RotateLeft(x06 ^ x11, 12);
                    x01 += x06;
                    temp = x12 ^ x01;
                    x12 = (temp << 8) ^ (temp >> -8);// Integers.RotateLeft(x12 ^ x01, 8);
                    x11 += x12;
                    temp = x06 ^ x11;
                    x06 = (temp << 7) ^ (temp >> -7);// Integers.RotateLeft(x06 ^ x11, 7);
                    x02 += x07;
                    temp = x13 ^ x02;
                    x13 = (temp << 16) ^ (temp >> -16);// Integers.RotateLeft(x13 ^ x02, 16);
                    x08 += x13;
                    temp = x07 ^ x08;
                    x07 = (temp << 12) ^ (temp >> -12);// Integers.RotateLeft(x07 ^ x08, 12);
                    x02 += x07;
                    temp = x13 ^ x02;
                    x13 = (temp << 8) ^ (temp >> -8);// Integers.RotateLeft(x13 ^ x02, 8);
                    x08 += x13;
                    temp = x07 ^ x08;
                    x07 = (temp << 7) ^ (temp >> -7);// Integers.RotateLeft(x07 ^ x08, 7);
                    x03 += x04;
                    temp = x14 ^ x03;
                    x14 = (temp << 16) ^ (temp >> -16);// Integers.RotateLeft(x14 ^ x03, 16);
                    x09 += x14;
                    temp = x04 ^ x09;
                    x04 = (temp << 12) ^ (temp >> -12);// Integers.RotateLeft(x04 ^ x09, 12);
                    x03 += x04;
                    temp = x14 ^ x03;
                    x14 = (temp << 8) ^ (temp >> -8);// Integers.RotateLeft(x14 ^ x03, 8);
                    x09 += x14;
                    temp = x04 ^ x09;
                    x04 = (temp << 7) ^ (temp >> -7);// Integers.RotateLeft(x04 ^ x09, 7);
                }
        ...
        internal unsafe static void ChachaCore(int rounds, uint[] input, uint[] x)
        {
            ...
            fixed (uint* px = x)
            {
                ChaChaBurstHelper.ChachaCore(rounds, pinput, px);
            }
#else
